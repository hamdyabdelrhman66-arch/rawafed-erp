...
@Component({
  selector: 'raw-medical-step',
  standalone: true,
  imports: MATERIAL_FORM_IMPORTS,
  templateUrl: './medical-step.component.html',
  styleUrls: ['./medical-step.component.scss']})
export class MedicalStepComponent {
  @Input({ required: true }) group!: FormGroup;
  @Input({ required: true }) bloodTypes: string[] = [];
}
