...
const shape = (entry: any) => ({
  ...
  createdByName: entry.createdBy?.displayName || entry.createdBy?.username || null,
  approvedByName: entry.approvedBy?.displayName || entry.approvedBy?.username || null,
  postedByName: entry.postedBy?.displayName || entry.postedBy?.username || null,
  branchName: entry.branch?.nameAr || entry.branch?.name || null,
  academicYearName: entry.academicYear?.name || null,
  lines: entry.lines.map((line: any) => ({
    ...line,
    accountCode: line.account?.code || null,
    accountNameAr: line.account?.nameAr || null,
    accountNameEn: line.account?.nameEn || null,
    costCenterCode: line.costCenter?.code || null,
    costCenterNameAr: line.costCenter?.nameAr || null,
    costCenterNameEn: line.costCenter?.nameEn || null,
